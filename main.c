...
extern void initialise_monitor_handles(void); //semihosting funstion 
...
int main(void)
{
	initialise_monitor_handles(); // compulsory to initalise before using printf
	enable_processor_faults();

	init_scheduler_stack(SCHED_STACK_START);
	printf("Excution Begins \n");
